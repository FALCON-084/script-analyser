 ...
 * #L%
 */
package com.ust.lib.jsqlparser.statement.replace;

import java.util.List;

import com.ust.lib.jsqlparser.expression.Expression;
import com.ust.lib.jsqlparser.expression.operators.relational.ItemsList;
...
public class Replace implements Statement {
    ...
    /**
     * A list of {@link com.ust.lib.jsqlparser.schema.Column}s either from a "REPLACE mytab (col1, col2)
     * [...]" or a "REPLACE mytab SET col1=exp1, col2=exp2".
     *
     * @return a list of {@link com.ust.lib.jsqlparser.schema.Column}s
     */
    ...
    /**
     * A list of {@link com.ust.lib.jsqlparser.expression.Expression}s (from a "REPLACE mytab SET
