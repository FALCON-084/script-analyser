...
import com.ust.lib.jsqlparser.expression.ExpressionVisitorAdapter;
...
import com.ust.lib.jsqlparser.statement.select.OrderByVisitor;
...
import com.ust.lib.jsqlparser.statement.select.SelectVisitorAdapter;
 ...
 * {@link com.ust.lib.jsqlparser.statement.update.Update}
 */
public class UpdateDeParser implements OrderByVisitor {
     ...
     * {@link com.ust.lib.jsqlparser.statement.select.Select}s. It has to share the same<br>
     * StringBuilder (buffer parameter) as this object in order to work
