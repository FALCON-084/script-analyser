...
import com.ust.lib.jsqlparser.statement.create.table.ColumnDefinition;
import com.ust.lib.jsqlparser.statement.create.table.CreateTable;
import com.ust.lib.jsqlparser.statement.create.table.Index;
import com.ust.lib.jsqlparser.statement.select.PlainSelect;

/**
 * A class to de-parse (that is, tranform from JSqlParser hierarchy into a string) a
 * {@link com.ust.lib.jsqlparser.statement.create.table.CreateTable}
 */
