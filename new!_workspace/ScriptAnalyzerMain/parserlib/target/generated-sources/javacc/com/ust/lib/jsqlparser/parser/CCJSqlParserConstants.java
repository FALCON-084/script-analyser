...
public interface CCJSqlParserConstants {
  ...
  int K_CALL = 155;
  /** RegularExpression Id. */
  int ST_SEMICOLON = 156;
  /** RegularExpression Id. */
  int OP_GREATERTHANEQUALS = 157;
  /** RegularExpression Id. */
  int OP_MINORTHANEQUALS = 158;
  /** RegularExpression Id. */
  int OP_NOTEQUALSSTANDARD = 159;
  /** RegularExpression Id. */
  int OP_NOTEQUALSBANG = 160;
  /** RegularExpression Id. */
  int DT_ZONE = 161;
  /** RegularExpression Id. */
  int S_DOUBLE = 162;
  ...
  int HEX_VALUE = 166;
  /** RegularExpression Id. */
  int LINE_COMMENT = 167;
  /** RegularExpression Id. */
  int MULTI_LINE_COMMENT = 168;
  /** RegularExpression Id. */
  int S_IDENTIFIER = 169;
  /** RegularExpression Id. */
  int LETTER = 170;
  /** RegularExpression Id. */
  int PART_LETTER = 171;
  /** RegularExpression Id. */
  int S_CHAR_LITERAL = 172;
  /** RegularExpression Id. */
  int S_QUOTED_IDENTIFIER = 173;
  /** RegularExpression Id. */
  int ESC = 174;
