...
window.onload = function() {
	arrResponse=${data};
	var i;
    var out = "<table border=3><caption style=color:white;background-color:Tomato;>CONSOLIDATED TABLE</caption><tr bgcolor=#87cefa;><th>Code Block</th><th>Action</th><th>Source Table</th><th>Target Table</th><th>Standalone Table</th></tr>";
